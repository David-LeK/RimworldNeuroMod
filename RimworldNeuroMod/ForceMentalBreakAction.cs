        ...
        protected override UniTask ExecuteAsync(ForceMentalBreakData? data)
        {
            ...
            if (data.BreakDef is MentalBreakDef mentalBreakDef)
            {
                ...
                else
                {
                    ...
                    Context.Send($"Could not force the mental break on {pawn.Name.ToStringShort}.", silent: true);
                }
            }
            else if (data.BreakDef is InspirationDef inspirationDef)
            {
                ...
                else
                {
                    ...
                    Context.Send($"Could not grant the inspiration to {pawn.Name.ToStringShort}.", silent: true);
                }
            }
